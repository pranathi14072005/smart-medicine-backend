...
public class UserService {
    ...
    public Map<String, Long> getUserStats() {
        return Map.of("total", userRepository.count(), "users", userRepository.countByRole(User.Role.USER), "admins", userRepository.countByRole(User.Role.ADMIN), "pharmacists", userRepository.countByRole(User.Role.PHARMACIST));
    }

    @java.lang.SuppressWarnings("all")
    public UserService(final UserRepository userRepository, final PasswordEncoder passwordEncoder, final ModelMapper modelMapper) {
